...
#define	VELOCIDADE_JOGADORES 15 //VELOCIDADE DE MOVIMENTO DOS JOGADORES
...
void JanelaPlacar(void){
	...
	sprintf (label, "Alunos: Antony Alkmim | Vinicius Alves");
